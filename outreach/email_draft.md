...
Along the way I ran into two textual ambiguities I'd value your take on: Eq. 21's spin-change
prefactor exponent (printed as 1/3, but 1/2 in the Volonteri et al. 2013 formula it cites), and
Eq. 22's $\langle M_{\rm avg}\rangle$/$\rho$ definition (star-only vs. BH-inclusive — a choice
that turns out to control nearly every result I get downstream, including both of your Section
5.4 open questions, which I attempted with the validated pipeline).
